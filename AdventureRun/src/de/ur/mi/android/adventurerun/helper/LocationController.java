...
public class LocationController implements LocationListener {
	...
	// UPDATE_TIME und UPDATE_DISTANCE werden als Konstanten gespeichert - man muss schauen, ob es später vielleicht sinnvoller wäre, die Werte ändern zu können
	...
	// Location Provider festlegen - im Moment wird der Standardprovider ausgewählt. Ich habe die Methode ausgelagert, damit man ggf. nachträglich den Provider manuell bzw. nach Kriterien auswählen kann
